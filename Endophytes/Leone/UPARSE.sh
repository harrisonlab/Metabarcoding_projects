...
$PROJECT_FOLDER/metabarcoding_pipeline/scripts/slurm/slurm/PIPELINE.sh -c OTU $PROJECT_FOLDER $RUN FUN 23 21 FUN.otus.fa
...
$PROJECT_FOLDER/metabarcoding_pipeline/scripts/slurm/PIPELINE.sh -c OTU $PROJECT_FOLDER $RUN BAC 17 21 BAC.otus.fa
